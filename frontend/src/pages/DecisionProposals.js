    ...
    <div style={{ minHeight: "100vh", position: "relative", fontFamily: "'Sora', 'Space Grotesk', 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ ...ui.container, position: "relative", zIndex: 1, display: "grid", gap: 16 }}>
        ...
        {filteredProposals.length === 0 ? (
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 14, color: palette.muted, lineHeight: 1.6, maxWidth: 540 }}>
              {proposalDecisions.length === 0
                ? "New decision proposals usually begin in conversations and then enter this queue once they’re recorded as proposed or under review."
          ...
          <section className="ui-enter" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 14, "--ui-delay": "150ms" }}>
            {filteredProposals.map((decision) => (
              <Link
              ...
              >
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10, flexWrap: "wrap" }}>
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    <h3 style={{ margin: 0, fontSize: 19, color: palette.text, fontWeight: 800, lineHeight: 1.15 }}>{decision.title || "Untitled proposal"}</h3>
                ...
                <div style={{ marginTop: "auto", display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", flexWrap: "wrap", paddingTop: 12, borderTop: `1px solid ${palette.border}` }}>
                  <span style={{ fontSize: 12, color: palette.muted }}>
                  ...
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 5, color: palette.accent, fontWeight: 700, fontSize: 12 }}>
                    Review proposal <ArrowRightIcon style={{ width: 12, height: 12 }} />
                  </span>
                </div>
              </Link>
            ))}
