...
urlpatterns = [
    ...
    path('sprints/<int:sprint_id>/decision-twin/', agile_fresh.sprint_decision_twin, name='sprint_decision_twin'),
    path('sprints/<int:sprint_id>/decision-twin/apply/', agile_fresh.apply_sprint_decision_twin, name='apply_sprint_decision_twin'),
