...
urlpatterns = [
    ...
    path('calendar/oauth/start/', calendar_oauth_start, name='calendar_oauth_start'),
    path('calendar/oauth/callback/', calendar_oauth_callback, name='calendar_oauth_callback'),
