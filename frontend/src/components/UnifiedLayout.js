    ...
    () =>
      darkMode
        ...
        : {
            ...
            panelBgAlt: "#e0e8f3",
            panelGlass: "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(234, 240, 248, 0.96))",
            border: "rgba(21, 42, 74, 0.2)",
            text: "#0f172a",
            muted: "#526176",
            hover: "rgba(29, 78, 216, 0.08)",
            glowOne: "rgba(59, 130, 246, 0.16)",
            glowTwo: "rgba(36, 120, 87, 0.1)",
            buttonBg: "rgba(248, 251, 255, 0.94)",
            menuSurface: "#ffffff",
            accent: "#1d4ed8",
            accentSoft: "rgba(29, 78, 216, 0.13)",
            avatarGradient: "linear-gradient(135deg, #1d4ed8, #3b82f6)",
            avatarText: "#f8fbff",
            primaryGradient: "linear-gradient(135deg, #1d4ed8, #3b82f6)",
            primaryText: "#f8fbff",
            primaryBorder: "rgba(29, 78, 216, 0.32)",
            headerBg: "rgba(248, 251, 255, 0.82)",
            headerShadow: "0 18px 36px rgba(15, 23, 42, 0.1)",
            backdrop:
              "url('/brand/knoledgr-grid.svg'), radial-gradient(920px 560px at -8% -8%, rgba(59, 130, 246, 0.16), transparent 62%), radial-gradient(760px 520px at 108% -4%, rgba(36, 120, 87, 0.1), transparent 58%), linear-gradient(180deg, #eaf0f8, #f8fbff)",
          },
    [darkMode]
  );
