...
from . import views, integration_endpoints, github_endpoints, github_app_views, github_app_pr_views, github_app_import_views
...
urlpatterns = [
    ...
    path('github/app/repos/<int:repo_pk>/project/', github_app_views.github_app_repo_project, name='github_app_repo_project'),
    path('github/app/repos/<int:repo_pk>/import/', github_app_import_views.github_app_repo_import, name='github_app_repo_import'),
