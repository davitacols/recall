...
urlpatterns = [
    ...
    path('ai/copilot/actions/', agi_copilot_actions, name='agi_copilot_actions'),
    ...
    path('dashboard/workspace-briefing/', views.workspace_briefing, name='workspace_briefing'),
