...
urlpatterns = [
    ...
    path('github/decisions/<int:decision_id>/timeline/', github_endpoints.decision_timeline, name='decision-timeline'),
    ...
    path('github/issues/<int:issue_id>/timeline/', github_endpoints.issue_timeline, name='issue-timeline'),
]
